...
class _$_SettingsState implements _SettingsState {
  const _$_SettingsState({required this.isDarkTheme});
  ...
  @override
  String toString() {
    return 'SettingsState(isDarkTheme: $isDarkTheme)';
  }
...
abstract class _SettingsState implements SettingsState {
  const factory _SettingsState({required final bool isDarkTheme}) =
      _$_SettingsState;
